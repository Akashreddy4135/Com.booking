...
public class xmlcode1 {
    ...
    public void setUp() {
        ...
        driver.findElement(By.xpath(
                "//span[@class='Icon-module_root_lkZX8 Tags-moduleicon_XQsOM Icon-moduleroot--size-small__8pl9w']"))
                .click();
        ...
        WebElement to = driver.findElement(By.xpath(
                "//button[@class='ShellButton-module_btn__tCJzz' and @data-ui-name='input_location_to_segment_0']"));
        to.click();
        WebElement toLocation = driver
                .findElement(By.xpath("//input[@class='AutoComplete-module_textInput__tZuOx ']"));
        toLocation.click();
    ...
    @Test(groups = {"smoke"}, dataProvider = "flightData", dataProviderClass = ParRunner.class)
    ...
    @Test(groups = {"regression"}, dataProvider = "flightData", dataProviderClass = ParRunner.class)
    public void testGetLongestDuration(String startLocation, String destinationLocation) {
        ...
        List<WebElement> flightElements = wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(
                By.xpath("//li[@class='List-module_item_VKfBl List-moduleitem--spacing-medium__j8uHx']")));
